Contributing to yii2-export
===========================
Looking to contribute something to yii2-export? **Here's how you can help.**
...
[extension documentation and demos](http://demos.krajee.com/export) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-export
-----------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-export_.
...
- What version of jQuery are you using? And what version of yii2-export?
- Are you using yii2-export with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-export
------------------------------------------
Before starting work on a major feature for yii2-export, **read the
[documentation](http://demos.krajee.com/export)  first** or you may risk spending a considerable amount of
...
yii2-export regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-export that contain test cases and
...
It should also be made clear that **all code contributed to yii2-export** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[issue-search]: https://github.com/kartik-v/yii2-export/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/yii2-export/issues
[licensing]: https://github.com/kartik-v/yii2-export/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-export
[requesting-features]: #requesting-features-in-yii2-export